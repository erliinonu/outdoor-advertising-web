<?php
	...
	//titik_faspend
	$wfsUrl = file_get_contents("http://localhost:8080/geoserver/pendidikan_wng/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=pendidikan_wng%3Afaspend_wng&outputFormat=application%2Fjson");
